...
'''filename = PhotoImage(file="pngfile.png")
background_label = Label(top, image=filename)
background_label.place(x=0, y=0, relwidth=1, relheight=1)
C.pack()''' #background image
def browsefunc():
    ...
    data = Label(text="Done!!")
    data.place(x=10,y=15)
    ...
    def show_entry_fields():
        ...
        if(result==1):
            #print("Spam")
            spam = Label(text="Spam")
            spam.place(x=10,y=107)
        else:
            #print("Ham")
            spam = Label(text="Ham")
            spam.place(x=10,y=107)
    ...
    e1 = Entry(window)
    e1.place(x=10,y=43,width=354, height=30)
    button=Button(window, text='Show', command=show_entry_fields)
    button.place(x=10,y=74)
